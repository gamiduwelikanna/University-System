...
<body>
    <div class="container">
        ...
        <div class="levels">
            ...
            <div class="link1"><a href="viewCourses.php">View Courses</a></div>
        </div>
        ...
        <div class="levels">
            <!-- Add your operation links here -->
            <div class="link2"><a href="addCourses.php">Add Courses</a></div>
        </div>
        ...
        <div class="levels">
            <!-- Add your operation links here -->
            <div class="link3"><a href="updateCourses.php">Update Courses</a></div>
        </div>
        ...
        <div class="levels">
            <!-- Add your operation links here -->
            <div class="link4"><a href="deleteCourses.php">Delete Courses</a></div>
        </div>
