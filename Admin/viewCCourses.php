...
<head>
    ...
    <title>View Corequired Courses</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To View Corequired Courses</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionViewCCourse.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <button type="submit">View Corequired Course</button>
            </form>
        </div>
    </div>
</body>
