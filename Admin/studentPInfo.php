...
<body>
    <div class="container">
        ...
        <div class="levels">
            ...
            <div class="link1"><a href="viewStudentP.php">View Students</a></div>
        </div>
        ...
        <div class="levels">
            <!-- Add your operation links here -->
            <div class="link2"><a href="addStudentP.php">Add Students</a></div>
        </div>
        ...
        <div class="levels">
            <!-- Add your operation links here -->
            <div class="link3"><a href="updateStudentP.php">Update Students</a></div>
        </div>
        ...
        <div class="levels">
            <!-- Add your operation links here -->
            <div class="link4"><a href="deleteStudentP.php">Delete Students</a></div>
        </div>
