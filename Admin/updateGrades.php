...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Update Student Grades</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdateGrades.php" method="post">
                <input type="text" id="StudentID" name="StudentID" placeholder="Student ID"><br>
                <input type="text" id="InstructorID" name="InstructorID" placeholder="Instructor ID"><br>
                <input type="text" id="CourseID" name="CourseID" placeholder="Course ID"><br>
                <input type="text" id="gradeValue" name="gradeValue" placeholder="Grade Value"><br>
                <input type="text" id="Date" name="Date" placeholder="Date(YYYY-MM-DD)"><br>

                <button type="submit">Update Student Grades</button>
            </form>
        </div>
    </div>
</body>
