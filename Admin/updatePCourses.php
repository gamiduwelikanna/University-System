...
<head>
    ...
    <title>Update Prerequired Courses</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Update Prerequired Courses</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdatePCourse.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <input type="text" name="PreReqCourseID1" placeholder="Current Prerequired Course ID"><br>
                <input type="text" name="PreReqCourseID2" placeholder="New Prerequired Course ID"><br>
                <button type="submit">Update Prerequired Course</button>
            </form>
        </div>
    </div>
</body>
