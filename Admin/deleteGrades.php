...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Delete Student Grades</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionDeleteGrades.php" method="post">
                ...
                <button type="submit">Delete Student Grades</button>
            </form>
        </div>
    </div>
</body>
