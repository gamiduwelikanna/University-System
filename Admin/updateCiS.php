...
<head>
    ...
    <title>Update Courses In Semesters</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Update Courses In Semesters</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdateCiS.php" method="post">
                <input type="text" name="StudentID" placeholder="Student ID"><br>
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <input type="text" name="NewSemester" placeholder="New Semester"><br>
                <button type="submit">Update Courses In Semesters</button>
            </form>
        </div>
    </div>
</body>
