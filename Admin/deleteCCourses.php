...
<head>
    ...
    <title>Delete Corequired Courses</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Delete Corequired Courses</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionDeleteCCourse.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <input type="text" name="CoReqCourseID" placeholder="Corequired Course ID"><br>
                <button type="submit">Delete Corequired Course</button>
            </form>
        </div>
    </div>
</body>
