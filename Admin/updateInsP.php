...
<head>
    ...
    <title>Update Instructor Perosnal Information</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Update Instructor Perosnal Information</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdateInsP.php" method="post">
                ...
                <button type="submit">Update Instructor Perosnal Information</button>
            </form>
        </div>
    </div>
</body>
