...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Add Course</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdateCourse.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <input type="text" name="Title" placeholder="Title"><br>
                <input type="text" name="Description" placeholder="Description"><br>
                <input type="text" name="CreditValue" placeholder="Credit Value"><br>
