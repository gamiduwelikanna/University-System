...
<head>
    ...
    <title>View Instructor Contact Information</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To View Instructor Contact Information</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionViewInsC.php" method="post">
                <input type="text" name="InstructorID" placeholder="Instructor ID"><br>
                <button type="submit">View Instructor Contact Information</button>
            </form>
        </div>
    </div>
</body>
