...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Add Student Grades</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionAddGrades.php" method="post">
                ...
                <button type="submit">Add Student Grades</button>
            </form>
        </div>
    </div>
</body>
