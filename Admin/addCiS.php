...
<head>
    ...
    <title>Add Courses In Semesters</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Add Courses In Semesters</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionAddCiS.php" method="post">
                ...
                <button type="submit">Add Courses In Semesters</button>
            </form>
        </div>
    </div>
</body>
