...
<head>
    ...
    <title>Update Corequired Courses</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Update Corequired Courses</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdateCCourse.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <input type="text" name="CoReqCourseID1" placeholder="Current Corequired Course ID"><br>
                <input type="text" name="CoReqCourseID2" placeholder="New Corequired Course ID"><br>
                <button type="submit">Update Corequired Course</button>
            </form>
        </div>
    </div>
</body>
