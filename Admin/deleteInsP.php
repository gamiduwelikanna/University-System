...
<head>
    ...
    <title>Delete Instructor Perosnal Information</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Delete Instructor Perosnal Information</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionDeleteInsP.php" method="post">
                <input type="text" name="InstructorID" placeholder="Instructor ID"><br>
                <button type="submit">Delete Instructor Perosnal Information</button>
            </form>
        </div>
    </div>
</body>
