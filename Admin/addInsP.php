...
<head>
    ...
    <title>Add Instructor Perosnal Information</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Add Instructor Perosnal Information</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionAddInsP.php" method="post">
                ...
                <button type="submit">Add Instructor Perosnal Information</button>
            </form>
        </div>
    </div>
</body>
