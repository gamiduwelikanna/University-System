...
if ($courseResult->num_rows > 0) {
    // Course found, now retrieve prereq information
    $query = "SELECT * FROM prereqcourse WHERE courseID='$courseID'";
    ...
    if ($result) {
        if ($result->num_rows > 0) {
            ...
            echo '<title>Prerequisite Course Information</title>';
            echo '<style>';
            echo 'body {';
            ...
            echo '<h3>Course ID: ' . $courseID . '</h3>';
            
            while ($row = $result->fetch_assoc()) {
                $preReqCourseID = $row["preReqCourseID"];

                echo '<p>Prerequisite Course ID: ' . $preReqCourseID . '</p>';
            ...
            echo '<div class="container">';
            echo '<div class="content">';
            echo '<h3>No Prerequisite Course found for Course ID: ' . $courseID . '</h3>';
            echo '</div>';
            echo '</div>';
            echo '</body>';
            echo '</html>';
    ...
    echo '<div class="content">';
    echo '<h3>Error</h3>';
    echo '<p>No course found with the provided Course ID.</p>';
    echo '</div>';
    echo '</div>';
    echo '</body>';
    echo '</html>';
