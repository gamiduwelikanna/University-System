...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $bachelors = $row["Bachelor's"];
            $masters = $row["Master's"];
            $phd = $row["Ph.D."];
            ...
            echo '<p>Enrollment Status: ' . $enrollmentStatus . '</p>';
            echo '<p>Advisor Name: ' . $advisorName . '</p>';
            echo '<p>Bachelor\'s: ' . $bachelors . '</p>';
            echo '<p>Master\'s: ' . $masters . '</p>';
            echo '<p>Ph.D.: ' . $phd . '</p>';
