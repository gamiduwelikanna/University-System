...
if ($courseResult->num_rows > 0) {
    ...
    $query = "SELECT * FROM coreqcourse WHERE courseID='$courseID'";
    ...
    if ($result) {
        if ($result->num_rows > 0) {
            ...
            echo '<title>Corequisite Course Information</title>';
            echo '<style>';
            echo 'body {';
            ...
            while ($row = $result->fetch_assoc()) {
                $coReqCourseID = $row["coReqCourseID"];

                echo '<p>Corequisite Course ID: ' . $coReqCourseID . '</p>';
            ...
            echo '<div class="container">';
            echo '<div class="content">';
            echo '<h3>No Corequisite Course found for Course ID: ' . $courseID . '</h3>';
            echo '</div>';
            echo '</div>';
            echo '</body>';
            echo '</html>';
