...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($existingResult->num_rows > 0) {
        // Record already exists, display an error message
        displayError("Error: Record already exists.Cannot re-enter an existing record.");
    } else {
        // Record doesn't exist, insert the new record
        $insertQuery = "INSERT INTO instructor_contactinfo (facultyID, contactInfo, email) VALUES ('$instructorID', '$contactInfo', '$email')";
