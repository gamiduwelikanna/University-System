...
if ($existingResult->num_rows > 0) {
    ...
    $deleteQuery = "DELETE FROM teaches WHERE facultyID='$instructorID' AND courseID='$courseID'";
    ...
    if ($connection->query($deleteQuery) === TRUE) {
        ...
        echo '<title>Teaching History Deleted</title>';
        echo '<style>';
        echo 'body {';
        ...
        echo '<h3>Teaching History Deleted</h3>';
        echo '<p>Teaching history deleted successfully!</p>';
        echo '</div>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
    ...
    displayError("Error: Record does not exist. Cannot delete a non-existing record.");
}
