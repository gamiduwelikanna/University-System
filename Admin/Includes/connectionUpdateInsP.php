...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($existingResult->num_rows > 0) {
        ...
        $updateQuery = "UPDATE instructor SET password_='$password', name='$name', department='$department' WHERE facultyID='$instructorID'";
        ...
        if ($connection->query($updateQuery) === TRUE) {
            ...
            echo '<title>Instructor Information Updated</title>';
            echo '<style>';
            echo 'body {';
            ...
            echo '<h3>Instructor Information Updated</h3>';
            echo '<p>Instructor personal information updated successfully!</p>';
            echo '</div>';
            echo '</div>';
            echo '</body>';
            echo '</html>';
        } else {
            displayError("Error updating record: " . $connection->error);
        }
    } else {
        displayError("Record does not exist. You cannot update a non-existing record.");
    }
