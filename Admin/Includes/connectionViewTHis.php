...
$query = "SELECT * FROM teaches WHERE facultyID='$instructorID' AND courseID='$courseID'";
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        echo '<title>Teaching History</title>';
        echo '<style>';
        echo 'body {';
        ...
        echo '<div class="content">';
        echo '<h3>Teaching History</h3>';
        echo '<p>No teaching history found for the provided Instructor ID and Course ID.</p>';
        echo '</div>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
