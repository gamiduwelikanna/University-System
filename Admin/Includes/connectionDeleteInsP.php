...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($existingResult->num_rows > 0) {
        ...
        $deleteQuery = "DELETE FROM instructor WHERE facultyID='$instructorID'";
        ...
        if ($connection->query($deleteQuery) === TRUE) {
            ...
            echo '<title>Instructor Information Deleted</title>';
            echo '<style>';
            echo 'body {';
            ...
            echo '<h3>Instructor Information Deleted</h3>';
            echo '<p>Instructor personal information deleted successfully!</p>';
            echo '</div>';
            echo '</div>';
            echo '</body>';
            echo '</html>';
        } else {
            displayError("Error deleting record: " . $connection->error);
        }
    } else {
