...
if ($courseResult->num_rows > 0 && $preReqResult->num_rows > 0) {
    // Both course and prerequisite course found, now insert prereq information
    $insertQuery = "INSERT INTO prereqcourse (courseID, preReqCourseID) VALUES ('$courseID', '$preReqCourseID')";
    ...
    if ($connection->query($insertQuery) === TRUE) {
        ...
        echo '<h3>Prerequisite Course Information Added</h3>';
        echo '<p>Prerequisite course information added successfully!</p>';
        echo '</div>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
    } else {
        echo "Error inserting Prerequisite Course information: " . $connection->error;
    }
} else {
    echo '<html>';
    echo '<head>';
