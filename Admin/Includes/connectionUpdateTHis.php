...
if ($existingResult->num_rows > 0) {
    ...
    $updateQuery = "UPDATE teaches SET history='$teachingHistory' WHERE facultyID='$instructorID' AND courseID='$courseID'";
    ...
    if ($connection->query($updateQuery) === TRUE) {
        ...
        echo '<title>Teaching History Updated</title>';
        echo '<style>';
        echo 'body {';
        ...
        echo '<h3>Teaching History Updated</h3>';
        echo '<p>Teaching history updated successfully!</p>';
        echo '</div>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
    ...
    displayError("Error: Record does not exist. Cannot update a non-existing record.");
}
