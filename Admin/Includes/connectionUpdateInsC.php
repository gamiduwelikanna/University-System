...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkExistingQuery = "SELECT * FROM instructor_contactinfo WHERE facultyID = '$instructorID'";
    $existingResult = $connection->query($checkExistingQuery);

    if ($existingResult->num_rows > 0) {
        // Record exists, update the information
        $updateQuery = "UPDATE instructor_contactinfo SET contactInfo = '$contactInfo', email = '$email' WHERE facultyID = '$instructorID'";
        ...
        if ($connection->query($updateQuery) === TRUE) {
            ...
            echo '<title>Contact Information Updated</title>';
            echo '<style>';
            echo 'body {';
            ...
            echo '<h3>Contact Information Updated</h3>';
            ...
            displayError("Error: " . $updateQuery . "<br>" . $connection->error);
        }
    } else {
        // Record doesn't exist, display an error message
        displayError("Error: No record found with Instructor ID '$instructorID'");
    }
