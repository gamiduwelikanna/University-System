...
$query = "SELECT * FROM grade WHERE studentID = '$studentID' AND facultyID='$instructorID' AND courseID = '$courseID'";
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        echo '<title>Course Materials</title>';
        echo '<style>';
        echo 'body {';
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<p>Grade Value: ' . $gradeValue . '</p>';
            echo '<p>Date: ' . $date . '</p>';
            echo '<br>';
        }
        ...
        echo '<div class="content">';
        echo '<h3>Course Materials</h3>';
        echo '<p>No grades found with the provided Student ID, Instructor ID, and Course ID.</p>';
        echo '</div>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
