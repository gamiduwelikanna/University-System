...
if ($courseResult->num_rows > 0 && $coReqResult->num_rows > 0) {
    ...
    $deleteQuery = "DELETE FROM coreqcourse WHERE courseID='$courseID' AND coReqCourseID='$coReqCourseID'";
    ...
    if ($connection->query($deleteQuery) === TRUE) {
        ...
        echo '<title>Corequisite Course Information Deleted</title>';
        echo '<style>';
        echo 'body {';
        ...
        echo '<h3>Corequisite Course Information Deleted</h3>';
        echo '<p>Corequisite course information deleted successfully!</p>';
        echo '</div>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
    } else {
        echo "Error deleting Corequisite Course information: " . $connection->error;
    }
} else {
    echo '<html>';
    echo '<head>';
