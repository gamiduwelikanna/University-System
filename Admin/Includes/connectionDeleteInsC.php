...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($existingResult->num_rows > 0) {
        // Record exists, delete the record
        $deleteQuery = "DELETE FROM instructor_contactinfo WHERE facultyID = '$instructorID'";
        ...
        if ($connection->query($deleteQuery) === TRUE) {
            ...
            echo '<title>Contact Information Deleted</title>';
            echo '<style>';
            echo 'body {';
            ...
            echo '<h3>Contact Information Deleted</h3>';
            ...
            displayError("Error: " . $deleteQuery . "<br>" . $connection->error);
        }
    } else {
