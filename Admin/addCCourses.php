...
<head>
    ...
    <title>Add Corequired Courses</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Add Corequired Courses</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionAddCCourse.php" method="post">
                ...
                <button type="submit">Add Corequired Course</button>
            </form>
        </div>
    </div>
</body>
