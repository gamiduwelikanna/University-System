...
<head>
    ...
    <title>Delete Prerequired Courses</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Delete Prerequired Courses</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionDeletePCourse.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <input type="text" name="PreReqCourseID" placeholder="Prerequired Course ID"><br>
                <button type="submit">Delete Prerequired Course</button>
            </form>
        </div>
    </div>
</body>
