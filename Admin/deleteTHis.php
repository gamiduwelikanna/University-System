...
<head>
    ...
    <title>Delete Instructor Teaching History</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Delete Instructor Teaching History</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionDeleteTHis.php" method="post">
                <input type="text" name="InstructorID" placeholder="Instructor ID"><br>
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <button type="submit">Delete Instructor Teaching History</button>
            </form>
        </div>
    </div>
</body>
