...
<head>
    ...
    <title>Update Instructor Teaching History</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Update Instructor Teaching History</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdateTHis.php" method="post">
                ...
                <button type="submit">Update Instructor Teaching History</button>
            </form>
        </div>
    </div>
</body>
