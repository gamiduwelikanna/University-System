...
<head>
    ...
    <title>Add Prerequired Courses</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Add Prerequired Courses</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionAddPCourse.php" method="post">
                ...
                <button type="submit">Add Prerequired Course</button>
            </form>
        </div>
    </div>
</body>
