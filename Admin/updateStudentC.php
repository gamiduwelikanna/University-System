...
<head>
    ...
    <title>Update Student Contact Information</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Update Student Contact Information</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdateStudentC.php" method="post">
                <input type="text" name="StudentID" placeholder="Student ID"><br>
                <input type="text" name="ContactNo" placeholder="Contact No"><br>
                <button type="submit">Update Student Student Contact Information</button>
            </form>
        </div>
    </div>
</body>
