...
<head>
    ...
    <title>Delete Instructor Contact Information</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Delete Instructor Contact Information</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionDeleteInsC.php" method="post">
                <input type="text" name="InstructorID" placeholder="Instructor ID"><br>
                <button type="submit">Delete Instructor Contact Information</button>
            </form>
        </div>
    </div>
</body>
