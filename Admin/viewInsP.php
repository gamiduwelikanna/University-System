...
<head>
    ...
    <title>View Instructor Perosnal Information</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To View Instructor Perosnal Information</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionViewInsP.php" method="post">
                <input type="text" name="InstructorID" placeholder="Instructor ID"><br>
                <button type="submit">View Instructor Perosnal Information</button>
            </form>
        </div>
    </div>
</body>
