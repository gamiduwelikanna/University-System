...
<head>
    ...
    <title>Delete Courses In Semesters</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Delete Courses In Semesters</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionDeleteCiS.php" method="post">
                <input type="text" name="StudentID" placeholder="Student ID"><br>
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <button type="submit">Delete Courses In Semesters</button>
            </form>
        </div>
    </div>
</body>
