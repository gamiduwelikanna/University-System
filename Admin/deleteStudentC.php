...
<head>
    ...
    <title>Delete Student Contact Information</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Delete Student Contact Information</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionDeleteStudentC.php" method="post">
                <input type="text" name="StudentID" placeholder="Student ID"><br>
                <button type="submit">Delete Student Student Contact Information</button>
            </form>
        </div>
    </div>
</body>
