...
<head>
    ...
    <title>View Instructor Teaching History</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To View Instructor Teaching History</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionViewTHis.php" method="post">
                <input type="text" name="InstructorID" placeholder="Instructor ID"><br>
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <button type="submit">View Instructor Teaching History</button>
            </form>
        </div>
    </div>
</body>
