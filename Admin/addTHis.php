...
<head>
    ...
    <title>Add Instructor Teaching History</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Add Instructor Teaching History</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionAddTHis.php" method="post">
                ...
                <button type="submit">Add Instructor Teaching History</button>
            </form>
        </div>
    </div>
</body>
