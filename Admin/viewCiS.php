...
<head>
    ...
    <title>View Courses In Semesters</title>
    <style>
        body {
...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To View Courses In Semesters</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionViewCiS.php" method="post">
                <input type="text" name="StudentID" placeholder="Student ID"><br>
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <button type="submit">View Courses In Semesters</button>
            </form>
        </div>
    </div>
</body>
