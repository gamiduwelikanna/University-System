...
$query = "SELECT * FROM coursecview WHERE courseID = '$courseID'";
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        echo '<title>Corequired Courses</title>';
        echo '<style>';
        echo 'body {';
        ...
        echo '<h3>Corequired Courses</h3>';
        
        while ($row = $result->fetch_assoc()) {
            $courseID = $row["courseID"];
            $title = $row["title"];
            $crCourseID = $row["coReqCourseID"];
            
            echo '<p>Course ID: ' . $courseID . '</p>';
            echo '<p>Title: ' . $title . '</p>';
            echo '<p>Corequired Course ID: ' . $crCourseID . '</p>';
        ...
        echo '<div class="content">';
        echo '<h3>Corequired Courses</h3>';
        echo '<p>No corequisities found with the provided course ID.</p>'; // Add styling here
        echo '</div>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
