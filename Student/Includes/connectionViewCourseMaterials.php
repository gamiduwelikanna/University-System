...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        echo '<title>Courese Materials</title>';
        echo '<style>';
        echo 'body {';
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<p>Material ID: ' . $materialID . '</p>';
            echo '<p>Course related Instructor ID: ' . $facultyID . '</p>';
        ...
        echo '<div class="content">';
        echo '<h3>Courese Materials</h3>';
        echo '<p>No materials found with the provided course ID.</p>'; // Add styling here
        echo '</div>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
