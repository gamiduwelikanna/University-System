...
// Define an array of valid student usernames
$validUsernames = array("st1", "st2", "st3", "st4", "st5","st6","st7","st8","st9","st10");

if (in_array($inputUsername, $validUsernames)) {
    // User is valid
    // Now, let's query the 'login' table in the database to validate the user
    $stmt = $conn->prepare("SELECT studentID, password_ FROM student WHERE studentID = ?");
    ...
    if ($stmt->num_rows > 0) {
        ...
        if (password_verify($inputPassword, $hashedPassword)) {
            ...
            echo '</head>';
            echo '<body>';
            echo '<a class="home-link" href="http://localhost/University/System/Users/Student/student.php">Home</a>';
