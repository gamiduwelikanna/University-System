...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To View Instructors Related to Courses</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionViewCourseInstructors.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <button type="submit">View Instructors</button>
            </form>
        </div>
    </div>
</body>
