...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To View Corequired Courses related to a Course</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionViewC.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <button type="submit">View Corequired Courses</button>
            </form>
        </div>
    </div>
</body>
