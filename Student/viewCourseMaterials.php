...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To View Course Materials</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionViewCourseMaterials.php" method="post">
                <input type="text" name="CourseID" placeholder="Course ID"><br>
                <button type="submit">View Course Materials</button>
            </form>
        </div>
    </div>
</body>
