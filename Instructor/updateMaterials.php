...
<body>
    ...
    <center>
        <h2 class="login-title">Fill This Form To Update Course Materials<br>
        CourseID , Mterial ID and Instructor ID will unquiley identify<br>
        what you need to update.</h2>
    </center>
    <div class="container">
        <div class="form">
            <form action="Includes/connectionUpdateMaterials.php" method="post">
                ...
                <button type="submit">Update Course Materials</button>
            </form>
        </div>
    </div>
</body>
